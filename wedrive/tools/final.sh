...
# Координаты БЕЗ кавычек: в кавычках это один аргумент, программа падает на usage,
# а стенд молча показывает пустоту вместо результата.
$T $MD $MD $CH $UN r1 2>&1 | keep
echo
